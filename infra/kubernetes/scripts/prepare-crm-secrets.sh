...
runtime_keys=(
  ...
  AWS_STORAGE_BUCKET_NAME AWS_S3_REGION_NAME MEDIA_QUERYSTRING_AUTH
  MEDIA_QUERYSTRING_EXPIRE WELCOME_BOT_TOKEN WELCOME_BOT_USERNAME
...
runtime_args+=(
  ...
  "--from-literal=ALLOWED_HOSTS=gramly.tech,www.gramly.tech,crm.gramly.tech"
  ...
  "--from-literal=AWS_S3_ENDPOINT_URL=http://gramly-crm-minio.gramly-crm.svc.cluster.local:9000"
  "--from-literal=MEDIA_S3_PUBLIC_URL=https://gramly.tech/s3"
)
